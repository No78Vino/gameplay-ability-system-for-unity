...
namespace GAS.Runtime
{
    public static class GEN_GameplayTagCode
    {
        ...
        public static void InitTagList()
        {
            ...
            {
                { Ability, new GASTag(Ability, new int[] {  }, new int[] {  }) },
                { Ability_Attack, new GASTag(Ability_Attack, new int[] { Ability }, new int[] { Ability }) },
                { Ability_Defend, new GASTag(Ability_Defend, new int[] { Ability }, new int[] { Ability }) },
                { Ability_Die, new GASTag(Ability_Die, new int[] { Ability }, new int[] { Ability }) },
                { Ability_Dodge, new GASTag(Ability_Dodge, new int[] { Ability }, new int[] { Ability }) },
                { Ability_Jump, new GASTag(Ability_Jump, new int[] { Ability }, new int[] { Ability }) },
                { Ability_Move, new GASTag(Ability_Move, new int[] { Ability }, new int[] { Ability }) },
                { Ban, new GASTag(Ban, new int[] {  }, new int[] {  }) },
                { Ban_Motion, new GASTag(Ban_Motion, new int[] { Ban }, new int[] { Ban }) },
                { CD, new GASTag(CD, new int[] {  }, new int[] {  }) },
                { CD_Dodge, new GASTag(CD_Dodge, new int[] { CD }, new int[] { CD }) },
                { CD_FireBullet, new GASTag(CD_FireBullet, new int[] { CD }, new int[] { CD }) },
                { CD_Skill0, new GASTag(CD_Skill0, new int[] { CD }, new int[] { CD }) },
                { CD_Skill1, new GASTag(CD_Skill1, new int[] { CD }, new int[] { CD }) },
                { Event, new GASTag(Event, new int[] {  }, new int[] {  }) },
                { Event_Attacking, new GASTag(Event_Attacking, new int[] { Event }, new int[] { Event }) },
                { Event_Defending, new GASTag(Event_Defending, new int[] { Event }, new int[] { Event }) },
                { Event_Dodging, new GASTag(Event_Dodging, new int[] { Event }, new int[] { Event }) },
                { Event_Dying, new GASTag(Event_Dying, new int[] { Event }, new int[] { Event }) },
                { Event_InAir, new GASTag(Event_InAir, new int[] { Event }, new int[] { Event }) },
                { Event_Moving, new GASTag(Event_Moving, new int[] { Event }, new int[] { Event }) },
                { Event_PerfectDefending, new GASTag(Event_PerfectDefending, new int[] { Event }, new int[] { Event }) },
                { Faction, new GASTag(Faction, new int[] {  }, new int[] {  }) },
                { Faction_Enemy, new GASTag(Faction_Enemy, new int[] { Faction }, new int[] { Faction }) },
                { Faction_Player, new GASTag(Faction_Player, new int[] { Faction }, new int[] { Faction }) },
                { State, new GASTag(State, new int[] {  }, new int[] {  }) },
                { State_Buff, new GASTag(State_Buff, new int[] { State }, new int[] { State }) },
                { State_Buff_BulkUp, new GASTag(State_Buff_BulkUp, new int[] { State, State_Buff }, new int[] { State, State_Buff }) },
                { State_Buff_DefendBuff, new GASTag(State_Buff_DefendBuff, new int[] { State, State_Buff }, new int[] { State, State_Buff }) },
                { State_Debuff, new GASTag(State_Debuff, new int[] { State }, new int[] { State }) },
