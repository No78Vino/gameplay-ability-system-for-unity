            ...
            writer.Indent++;
            {
                ...
                writer.Indent++;
                {
                    ...
                    writer.Indent++;
                    {
                        ...
                        writer.WriteLine("{");
                        writer.WriteLine("    var requirement = data.ApplicationTagRequirement.Value;");
                        writer.WriteLine("    int[] all = null, any = null, none = null;");
                        writer.WriteLine("    if(requirement.All is {Count: > 0})");
                        writer.WriteLine("        all = requirement.All.ToArray();");
                        writer.WriteLine("    if(requirement.Any is {Count: > 0})");
                        writer.WriteLine("        any = requirement.Any.ToArray();");
                        writer.WriteLine("    if(requirement.None is {Count: > 0})");
                        writer.WriteLine("        none = requirement.None.ToArray();");
                        writer.WriteLine("    if(all != null || any != null || none != null)");
                        writer.WriteLine("        configs.Add(new ConfApplicationTagRequirement{ all = all, any = any, none = none });");
                        writer.WriteLine("}");
                        ...
                        writer.WriteLine("{");
                        writer.WriteLine("    var requirement = data.OngoingTagRequirement.Value;");
                        writer.WriteLine("    int[] all = null, any = null, none = null;");
                        writer.WriteLine("    if(requirement.All is {Count: > 0})");
                        writer.WriteLine("        all = requirement.All.ToArray();");
                        writer.WriteLine("    if(requirement.Any is {Count: > 0})");
                        ...
                        writer.WriteLine("        none = requirement.None.ToArray();");
                        writer.WriteLine("    if(all != null || any != null || none != null)");
                        writer.WriteLine("        configs.Add(new ConfOngoingTagRequirement{ all = all, any = any, none = none });");
                        writer.WriteLine("}");
                        ...
                        writer.WriteLine("{");
                        writer.WriteLine("    var requirement = data.RemoveGameplayEffectsWithTagRequirement.Value;");
                        writer.WriteLine("    int[] all = null, any = null, none = null;");
                        writer.WriteLine("    if(requirement.All is {Count: > 0})");
                        writer.WriteLine("        all = requirement.All.ToArray();");
                        writer.WriteLine("    if(requirement.Any is {Count: > 0})");
                        ...
                        writer.WriteLine("        none = requirement.None.ToArray();");
                        writer.WriteLine("    if(all != null || any != null || none != null)");
                        writer.WriteLine("        configs.Add(new ConfRemoveEffectWithTagRequirement{ all = all, any = any, none = none });");
                        writer.WriteLine("}");
                        ...
                        writer.WriteLine("{");
                        writer.WriteLine("    var requirement = data.ImmunityTagRequirement.Value;");
                        writer.WriteLine("    int[] all = null, any = null, none = null;");
                        writer.WriteLine("    if(requirement.All is {Count: > 0})");
                        writer.WriteLine("        all = requirement.All.ToArray();");
                        writer.WriteLine("    if(requirement.Any is {Count: > 0})");
                        ...
                        writer.WriteLine("        none = requirement.None.ToArray();");
                        writer.WriteLine("    if(all != null || any != null || none != null)");
                        writer.WriteLine("        configs.Add(new ConfEffectImmunityTagRequirement{ all = all, any = any, none = none });");
                        writer.WriteLine("}");
