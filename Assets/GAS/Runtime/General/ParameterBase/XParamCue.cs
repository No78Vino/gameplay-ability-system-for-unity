...
{
    public class XParamCue : IExParameterBase
    {
        ...
        [ShowInInspector] public IExParameterBase Param { get; set; }
        ...
        public void SetParam(IExParameterBase param)
        {
            Param = param;
        }
        ...
        public XParamCue(string cueType, IExParameterBase param = null, int[] requiredTags = null,
