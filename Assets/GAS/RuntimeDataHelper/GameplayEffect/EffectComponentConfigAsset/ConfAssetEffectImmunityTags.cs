...
{
    [Serializable]
    public class ConfAssetEffectImmunityTags: BaseGameplayEffectComponentConfigAsset
    {
        [TabGroup("AbilityAssetTags","免疫该效果的标签",SdfIconType.TagsFill)]
        [LabelText("标签")]
        [SerializeField] 
        [ListDrawerSettings]
        ...
        {
            return new ConfEffectImmunityTags()
            {
                tags = tags.ToArray()
            };
        }
